...
class StartupsControllerTest < ActionController::TestCase
  ...
  test "should create startup" do
    assert_difference('Startup.count') do
      post :create, startup: { description: @startup.description, logo: @startup.logo, name: @startup.name, owner_id: @startup.owner_id, website: @startup.website }
    end
  ...
  test "should update startup" do
    patch :update, id: @startup, startup: { description: @startup.description, logo: @startup.logo, name: @startup.name, owner_id: @startup.owner_id, website: @startup.website }
    assert_redirected_to startup_path(assigns(:startup))
  end
